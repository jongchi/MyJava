...
create table phoneInfo_basic (
    ...
    fr_name varchar2(20) constraint p_basic_name_nn not null,
    fr_phonenumber varchar2(20) constraint p_basic_phonenumber_nn not null,
...
create table phoneInfo_univ (
    ...
    fr_u_year number(1) default 1 constraint p_univ_year_ck check (fr_u_year>0 and fr_u_year<5) 
                                  constraint p_univ_year_nn not null,
...
create table phoneInfo_com (
    ...
    fr_c_company varchar2(20) default 'N' constraint p_com_company_nn not null,
