...
public class Member {
	...
	int ageCheck(int yearOfBirth) {	// 올해 나이 계산
		int age = YEAR - yearOfBirth;
		System.out.println("당신은 " + age + "살 입니다.");
		return age;
	}

	void fluShot(int age) { 	// 독감 예방 접종 여부
	...
	void healthCheck(int age) { // 건강검진 대상 여부 
	...
	public static void main(String[] args) {
		Scanner scanner = new Scanner(System.in);
			...
			int age = member.ageCheck(yearOfBirth);
			member.fluShot(age); 
			
			member.healthCheck(age);
